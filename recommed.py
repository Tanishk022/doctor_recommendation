...
with col1:
    ...
    # disease_query = st.text_input("Enter Disease/Symptom:", placeholder="Enter Disease/Symptom")
    # st.session_state.disease_query = disease_query

    # disease_query = st.text_input("Enter Disease/Symptom:", value=st.session_state.disease_query)
